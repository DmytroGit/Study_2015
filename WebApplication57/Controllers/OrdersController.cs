...
namespace WebApplication57.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var orders = db.Orders.Include(o => o.AspNetUsers).Include(o => o.Products);
        ...
        {
            ViewBag.Customers_Id = new SelectList(db.AspNetUsers, "Id", "FirstName");
        ...
        public ActionResult Create([Bind(Include = "Id,CountProduct,DateOrder,Products_Id,Customers_Id")] Orders orders)
        {
            ...
            ViewBag.Customers_Id = new SelectList(db.AspNetUsers, "Id", "FirstName", orders.Customers_Id);
